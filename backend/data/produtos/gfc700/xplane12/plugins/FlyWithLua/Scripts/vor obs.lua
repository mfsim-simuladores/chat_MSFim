...
create_command("MFSim/custom/OBS1up","Use Rotary to increase CDI1","CDI1Increment()", " ", "CDI1 = CDI1 % 360 ")
create_command("MFSim/custom/OBS1dn","Use Rotary to decrease CDI1","CDI1Decrement()", " ", "CDI1 = CDI1 % 360 ")
